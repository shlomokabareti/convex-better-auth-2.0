...
export type AuthClient<
  Client extends RequiredAuthClient = ReactAuthClient<BetterAuthClientOptions> & RequiredAuthClient,
...
const UserSubscription = ({ getAuthUserFn }: { getAuthUserFn: FunctionReference<"query"> }) => {
