...
6. [x] Extend `authAccounts` schema and component functions for token storage.
7. [x] Persist provider tokens on the account.
8. [x] Verify Google `id_token` against JWKS and use as primary userinfo source.
9. [x] Run full proof.
10. [ ] Commit, push, PR.
